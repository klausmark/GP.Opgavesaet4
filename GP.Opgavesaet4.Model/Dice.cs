...
public class Dice
{
    ...
    public void Throw()
    {
        // The Next-method of a Random-object returns a random number >= first parameter and < second parameter
        // (we call the method with the values 1 and 7, i.e. the return value will be within the range 1 to 6
